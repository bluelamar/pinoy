...
{{if eq .Sess.Role "Manager"}}
    <p><a href="/manager/add_room">Add or Update Room and Set Room Rates</a></p>
{{end}}
...
<table>
<tr>
<th>Room Number</th><th>Room Status</th><th>Registration</th><th>Guest Name</th>
